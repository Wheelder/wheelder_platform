...
$noteController->store_website_traffic($ip, $country, $city, $latitude, $longitude, $timezone);
...
<body>
    ...
    <header class="navbar navbar-dark sticky-top bg-dark  flex-md-nowrap p-0 shadow">
        ...
        <div class="footer-controls  form-control w-100 rounded-0 border-0">
            <!-- Icons with IDs -->
  ...
  <div class="modal-dialog ">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title" id="exampleModalLabel">Topics Suggestions</h5>
        ...
        <form action="/edu_note" method="POST">
         <div class="mb-3">
          ...
          <div class="modal-footer">
            ...
            <input type="submit" class="btn btn-dark " name="suggest_topic" >
          </div>
        </form>
      </div>
        ...
        <div class="row">
            ...
            <nav id="sidebarMenu" class="col-md-3 col-lg-2 d-md-block sidebar collapse">
                <div class="position-sticky pt-3 sidebar-sticky">
                    ...
                    <button type="button" class="btn btn-outline-dark btn-sm" data-bs-toggle="modal" data-bs-target="#exampleModal">&nbsp;&nbsp;<i class="fas fa-plus"></i>
             Topics Suggestions  </button>
                        <?php
        ...
        <main class="col-md-9 ms-sm-auto col-lg-10 px-md-4">
            <div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pt-3 pb-2 mb-3 ">
                ...
                if ($id) {
                    ...
                    echo $noteController->get_suggested_note($id);
                } else {
                    
                    echo $noteController->get_suggested_note(null);
                }
