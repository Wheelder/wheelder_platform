...
<body>
    ...
    <header class="navbar navbar-dark sticky-top bg-dark  flex-md-nowrap p-0 shadow">
        ...
        <div class="controls  form-control w-100 rounded-0 border-0">
            ...
            |
            <i id="chatBot" class="fas fa-comments" title="AI Chat Assistant"></i>
            |
        ...
        <div class="chat-header">
            ...
            <div class="chat-controls">
                <select id="modelSelector" class="form-select form-select-sm">
                    <option value="test">Test Mode (Demo)</option>
                    <option value="openai">OpenAI GPT</option>
                    <option value="ollama">Ollama (Local)</option>
                </select>
                <button id="closeChatWidget" class="btn-close"></button>
            </div>
        </div>
        <div class="chat-messages" id="chatMessages">
            <div class="message ai-message">
                <div class="message-content">
                    ...
                    <span>Hello! I'm your AI learning assistant. Currently in <strong>Test Mode</strong> - try asking "test" or "help" to see how I work! 🤖</span>
                </div>
            </div>
        </div>
        <div class="chat-input-container">
            <div class="input-group">
                <input type="text" id="chatInput" class="form-control" placeholder="Ask me anything..." maxlength="500">
        ...
        document.addEventListener('DOMContentLoaded', function() {
            ...
            function sendMessage() {
                ...
                switch(selectedModel) {
                    case 'test':
                        apiEndpoint = '/wheelder/apps/edu/api/test_ai.php';
                        break;
                    case 'openai':
                        apiEndpoint = '/wheelder/apps/edu/api/open_ai.php';
                        break;
                    case 'ollama':
                        apiEndpoint = '/wheelder/apps/edu/api/open_source_ai.php';
                        break;
                    default:
                        apiEndpoint = '/wheelder/apps/edu/api/test_ai.php';
                }
                ...
                fetch(apiEndpoint, {
                    ...
                    body: JSON.stringify({
                        userInput: message,
                        model: selectedModel === 'ollama' ? 'llama2' : undefined
                    })
                })
                .then(response => {
                ...
                .catch(error => {
                    typingIndicator.style.display = 'none';
                    addMessage('Sorry, there was a connection error. Please check your internet connection and try again.', 'ai');
            ...
            function addMessage(text, sender) {
                ...
                if (sender === 'ai') {
                    messageContent.innerHTML = `<i class="fas fa-robot"></i><span>${text}</span>`;
                } else {
            ...
            chatInput.addEventListener('input', function() {
                // Optional: Add character count or other input handling
            });
            ...
            modelSelector.addEventListener('change', function() {
                ...
                switch(selectedModel) {
                    case 'test':
                        statusMessage = '🧪 <strong>Test Mode</strong> activated! Try asking "test", "help", or any question to see how I work.';
                        break;
                    case 'openai':
                        statusMessage = '🤖 <strong>OpenAI GPT</strong> selected. I can provide advanced AI responses (requires valid API key).';
                        break;
                    case 'ollama':
                        statusMessage = '🏠 <strong>Ollama (Local)</strong> selected. Using local AI models for privacy (requires Ollama installation).';
                        break;
                }
