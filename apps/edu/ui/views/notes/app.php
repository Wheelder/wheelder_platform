...
$note->store_website_traffic($ip, $country, $city, $latitude, $longitude, $timezone);
...
<body>
    ...
    <header class="navbar navbar-dark sticky-top bg-dark  flex-md-nowrap p-0 shadow">
        ...
        <a class="navbar-brand col-md-2 col-lg-2 me-0 px-3 fs-6" href="/notes">Wheeleder</a>
