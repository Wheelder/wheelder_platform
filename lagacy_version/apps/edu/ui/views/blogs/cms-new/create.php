        ...
        <div class="row">
            <div class="col-12 col-lg-10 mx-auto">
                <div class="card shadow">
                    <div class="card-body">
                        <h2 class="card-title mb-4 fs-3">Create New Blog Post</h2>
                        <form action="/apps/edu/api/blogAPI.php" method="post" enctype="multipart/form-data" id="blogForm">
                            <input type="hidden" name="action" value="create-advanced">
                            ...
                            <div class="mb-3">
                                ...
                                <small class="form-text text-muted">Upload an image for your blog post (optional)</small>
                            </div>
                            ...
                            <div class="d-flex justify-content-end">
                                <button type="submit" class="btn btn-primary" name="insert">Create Blog Post</button>
                            </div>
                        </form>
                    </div>
                </div>
